...
add_fileset_file Image_Loader.sv SYSTEM_VERILOG PATH src/Image_Loader.sv TOP_LEVEL_FILE
...
add_interface_port conduit_end o_data data Output 24
add_interface_port conduit_end o_valid valid Output 1
